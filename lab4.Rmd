...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_natcho1>
...
[**https://natalie-cho.github.io/dsci_lab_4\_repo/**](https://natalie-cho.github.io/dsci_lab_4_repo/)
...
The echo = FALSE will prevent the code to display along with its
results.
...
The eval = FALSE option will prevent the code from being evaluated.
warning = FALSE will prevent the warnings from this code to be
displayed.
